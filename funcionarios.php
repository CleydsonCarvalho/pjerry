				...
				<form>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 app-margimBotomCamposFomr">
							...
							<input type="text" class="form-control" id="nome" placeholder="Digete o Nome Completo" required>
						</div>
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-6 app-margimBotomCamposFomr">
							<label for="representante">Endereço e complemento:</label>
						...
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 app-margimBotomCamposFomr">
							...
							<input type="text" class="form-control" id="numero" placeholder="Primeiro contato">
						</div>
						<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 app-margimBotomCamposFomr">
