				...
				<form>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 app-margimBotomCamposFomr">
							...
							<input type="text" class="form-control" id="nome" placeholder="Digite o nome da empresa ou o nome do fornecedor" required>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 app-margimBotomCamposFomr">
							<label for="cnpj">CNPJ / CPF:</label>
							<input type="text" class="form-control" id="cnpj" placeholder="Digite o CNPJ ou CPF">
						</div>
